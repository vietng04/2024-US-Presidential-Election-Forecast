...
clean_data |>
  head(5) |>
  kable(col.names = c("Pollster","Display Name","Pollster Rating ID","Grade","Poll Score", "Transparency Score","State","Start Date","End_Date", "Sample Size", "Election Date", "Party", "Answer","Candidate Name","Percentage"),
    booktabs = TRUE
  )

...
```{r}
#| label: Distribution of Percentage
#| echo: false
#| warning: false
#| message: false
...
ggplot(cleaned_data, aes(x = transparency_score)) +
  ...
  labs(title = "Distribution of transparency score", x = "transparency score", y = "Frequency") +
  theme_minimal()
```
...
```{r}
#| label: Poll Score by Sample Size and Transparency Score
#| echo: false
#| warning: false
#| message: false
ggplot(cleaned_data, aes(x = sample_size, y = pollscore)) +
  ...
  labs(title = "Poll Score by Sample Size and Transparency Score", x = "Sample Size", y = "Poll Score", color = "Transparency Score") +
  theme_minimal()
```
...
The @tbl-cleaned_data shows the 5 of all colunms.
...
ggplot(cleaned_data %>% filter(answer %in% c("Trump", "Harris")), aes(x = answer, y = pct, fill = party)) +
...
```{r}
#| label: transparency score for each candidate
#| fig-cap: Percentage of Support for Each Candidate
#| echo: false
#| warning: false
#| message: false
ggplot(cleaned_data, aes(x = answer, y = transparency_score, fill = answer)) +
  geom_boxplot() +
  labs(title = "Transparency Score by Candidate", x = "Candidate", y = "Transparency Score") +
  theme_minimal() +
...
#| fig-cap: Mean Percentage of Support for Trump and Harris over time
#| echo: false
#| warning: false
#| message: false
#| 
